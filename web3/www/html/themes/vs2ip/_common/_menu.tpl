...
<div class="sidebar-menu">
    <header class="logo-env">
        ...
        <div class="logo">
            <a href="index.php">
                <img src="{$WEBPATH}themes/{$THEMENAME}/images/logo_mini2.png" width="240" alt="" alt="VS2IP logo" />
            </a>
        </div>
        <!-- logo collapse icon -->
        ...
        <ul style='float:right;' class="user-info pull-none-xsm">
            ...
            <img  style="border:0px" src="/themes/tenant/images/Icon-user.png" alt="" class="img-circle" width="44" />
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="dropdown">
                        <a {*data-toggle="dropdown"*} href="index.php?logout=yes" {*style="background-color: white"*}>
