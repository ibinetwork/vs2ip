...
<html>
    ...
    <div class="page-container">
        ...
        <footer class="main" style="margin-left:16px;">
            <a href="www.vs2ip.com.br" style="color: #444; text-decoration: none;" target='_blank'>VS2IP</a> - <a href="#" target='_blank' style="color: #445; text-decoration: none;" ></a>{$currentyear}.
        </footer>
