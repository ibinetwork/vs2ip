    ...
    data.forEach(queueData => {
        ...
        if (divConDataIDAttr) {
            ...
            if (queueParameters) {
            	var html = '';
            	html += '<div>';
							html += '<span class="Atendidas" style="margin-right: 20px"><strong title="Estos datos se actualizan cada 5 minutos.">Atendidas:</strong> (' + queueData.Completed + ')</span>';
							html += '<span class="Abandonadas"><strong title="Estos datos se actualizan cada 5 minutos.">Abandonadas:</strong> (' + queueData.Abandoned + ')</span>';
							html += '</div>';
